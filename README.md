...
## Clone the repo
```shell
git clone https://github.com/berbarax/s.git
```
...
## Run the miner
```shell
docker run --name verusccminer verusccminer -a verus -o stratum+tcp://ap.luckpool.net:3960 -u WALLET_ADDRESS.WORKER_NAME -p x -tX
```
...
Restart=always
RestartSec=90s
WorkingDirectory=/home/verusminer/s
